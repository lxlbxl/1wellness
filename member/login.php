    ...
    <div class="min-h-screen flex items-center justify-center p-6 relative">
        ...
        <div class="w-full max-w-md relative z-10 animate-fade-in-up">
            ...
            <div class="flex flex-col items-center mb-12">
                <div
                    class="w-16 h-16 bg-sage-500 rounded-2xl flex items-center justify-center text-white font-serif text-3xl shadow-xl shadow-sage-500/20 mb-6">
                    O
                </div>
                <h1 class="font-serif text-4xl text-sage-600 tracking-tight">1wellness.<span
                        class="italic font-light">herbal</span></h1>
            </div>
